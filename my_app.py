...
app.layout = dbc.Container([
    ...
    dbc.Row([
        dbc.Col(html.H4(children=f'{round(df.distance.max(),2)} km'),
            class_name=('text-info',
            "text-center",
            'mb+4'),
            width=3),
        dbc.Col(html.H4(children=f'{round(df.speed.mean(),2)} km/h'),
            class_name=('text-info',
            "text-center",
            'mb+4'),
            width=3),
        dbc.Col(html.H4(children=f'{round(df.heart_rate.mean(),2)} bpm'),
            class_name=('text-info',
            "text-center",
            'mb+4'),
            width=3),
        dbc.Col(html.H4(children=f"D+ {round(df['d+'].max(),2)} m"),
            class_name=('text-info',
            "text-center",
            'mb+4'),
            width=3),
